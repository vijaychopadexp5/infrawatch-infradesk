...
(function() {
  ...
  /**
   * Filters using vanilla JS
   */
   const filterOptions = document.querySelectorAll(".filter-options");
   const baseContainers = document.querySelectorAll(".base-container");
   const filterOptionAll = document.querySelector(".filter-option-all");
   
   filterOptionAll.addEventListener("click", function(){
     filterOptionAll.classList.add('active');
     baseContainers.forEach((items) => {
   ...
   filterOptions.forEach((element, index) => {
     element.addEventListener("click", function(){
       filterOptionAll.classList.remove("active");
       filterOptions.forEach((e, i) => {
         if(i == index){
           e.classList.add("active");
           baseContainers.forEach((item) => {
             if(item.getAttribute("value") !== e.getAttribute("value")){
